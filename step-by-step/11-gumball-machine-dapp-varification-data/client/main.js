...
// ************ Connect to Gumball Machine component ************
document.getElementById("connectComponent").onclick = async function () {
  componentAddress = document.getElementById("componentAddress").value;
