...
mod yield_tokenizer {
    ...
    impl YieldTokenizer {
        pub fn instantiate_yield_tokenizer(
            expiry: Expiry,
            accepted_lsu: FungibleResourceManager,
            ...
            let pt_rm = ResourceBuilder::new_fungible(OwnerRole::None)
            ...
            let yt_rm = ResourceBuilder::new_ruid_non_fungible::<YieldTokenData>(
                OwnerRole::None,
            )
            .metadata(metadata! {
                init {
        ...
        fn retrieve_validator_component(
            ...
            let metadata: GlobalAddress = lsu_resource
        ...
        fn validate_lsu(input_lsu_address: FungibleResourceManager) -> bool {
            let metadata: GlobalAddress = input_lsu_address
                .get_metadata("validator")
                .unwrap()
                .unwrap_or_else(|| Runtime::panic(String::from("Not an LSU!")));
            ...
            input_lsu_address.address().as_node_id() == lsu_address.as_node_id()
        }
        ...
        pub fn tokenize_yield(
            ...
            assert_eq!(lsu_token.resource_address(), self.lsu_resource.address());
            ...
            let yt_bucket = self
                ...
                .mint_ruid_non_fungible(YieldTokenData {
                    underlying_lsu_resource: self.lsu_resource.address(),
        ...
        pub fn claim_yield(&mut self, yt_proof: NonFungibleProof) -> NonFungibleBucket {
            ...
            self.lsu_validator_component
                .unstake(required_lsu_bucket.into())
        }
        ...
        /// Retrieves the `FungibleResourceManager` of PT.
        ///
        /// # Returns
        ///
        /// * [`FungibleResourceManager`] - The fungible resource manager of PT.
        pub fn pt_resource(&self) -> FungibleResourceManager {
            self.pt_rm
        }

        /// Retrieves the `NonFungibleResourceManager` of YT.
        ///
        /// # Returns
        ///
        /// * [`NonFungibleResourceManager`] - The non-fungible resource manager of YT.
        pub fn yt_resource(&self) -> NonFungibleResourceManager {
            self.yt_rm
        }

        /// Retrieves the `FungibleResourceManager` of the underlying LSU.
        ///
        /// # Returns
        ///
        /// * [`FungibleResourceManager`] - The fungible resource manager of underlying LSU.
