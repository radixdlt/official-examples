...
struct YieldTokenizer {
    ...
    lsu_resource: FungibleResourceManager,
...
| `lsu_resource` | `FungibleResourceManager` | The `lsu_resource` is a field that will allow the component to verify that any LSU's the component receives is the correct LSU. Also, it allows to broadcast to any component using the `YieldTokenizer` the supported LSU.
...
| Name            | Type            | Arguments       | Type | Returns | Description
| --------------- | --------------- | ----------------- | --------------- | --------------- | --------------- |
| `retrieve_validator_component` | Function | `FungibleResourceManager` | `Global<Validator>` | Returns a `Global<Validator` component type | A function for utility used to retrieve the `Global<Validator>` component of a given LSU.
...
| Name            | Type            | Arguments       | Type | Returns | Description
| --------------- | --------------- | ----------------- | --------------- | --------------- | --------------- |
| `validate_lsu` | Function | `input_lsu_resource` | `FungibleResourceManager` | A `bool` of whether the given LSU is in fact the native LSU. | A function for utility used to validate whether the `ResourceAddress` is in fact from a native LSU.

```rust
fn validate_lsu(
    input_lsu_resource: FungibleResourceManager
    ) -> bool {
    // Validate LSU logic
}
```
...
| Name            | Type            | Arguments       | Type | Returns | Description
| --------------- | --------------- | ----------------- | --------------- | --------------- | --------------- |
| `pt_resource` | Method | N/A | N/A | The `FungibleResourceManager` of PT. | A method to retrieve the PT `FungibleResourceManager`.

```rust
pub fn pt_resource(&self) -> FungibleResourceManager {
    self.pt_rm
}
```
...
| Name            | Type            | Arguments       | Type | Returns | Description
| --------------- | --------------- | ----------------- | --------------- | --------------- | --------------- |
| `yt_resource` | Method | N/A | N/A | The `NonFungibleResourceManager` of YT. | A method to retrieve the YT `NonFungibleResourceManager`.

```rust
pub fn yt_resource(&self) -> RNonFungibleResourceManager{
    self.yt_rm
}
```
...
| Name            | Type            | Arguments       | Type | Returns | Description
| --------------- | --------------- | ----------------- | --------------- | --------------- | --------------- |
| `underlying_resource` | Method | N/A | N/A | The `FungibleResourceManager` of the underlying LSU. | A method to retrieve the LSU `FungibleResourceManager`.

```rust
pub fn underlying_resource(&self) -> FungibleResourceManager {
    self.lsu_resource
}
```
